...
function construirInformeWord(resultado, problema, versionLabel, textoOriginal) {
  ...
  const parts = [];
  parts.push(paragraphXml(`© Víctor Hugo Pérez Gallo – Universidad de Zaragoza – victorhugo.perez@unizar.es`, { italic: true, sz: 16 }));
  ...
  parts.push(headingXml("Informe SOCIOKAIROS EDU – Research Suite", 1));
  ...
  parts.push(headingXml("2. Área sociológica principal", 2));
  ...
  parts.push(headingXml("3. Reformulación del problema en forma de preguntas", 2));
  ...
  parts.push(headingXml("4. Variables (VI / VD)", 2));
  ...
  parts.push(headingXml("5. Correlaciones, hipótesis y marcos teóricos", 2));
  ...
  parts.push(headingXml("6. Unidad de análisis y diseño de estudio", 2));
  ...
  parts.push(headingXml("7. Operacionalización sugerida", 2));
  ...
  parts.push(headingXml("8. Fuentes de datos / bases recomendadas", 2));
  ...
  parts.push(headingXml("9. Alertas metodológicas", 2));
  generarAlertasMetodologicas(txtBase, resultado).split("\n").forEach(l => parts.push(paragraphXml(l, { bullet: true })));

  parts.push(headingXml("10. Tradiciones sociológicas compatibles", 2));
  generarTradiciones(resultado, txtBase).split("\n").forEach(l => parts.push(paragraphXml(l, { bullet: true })));

  parts.push(headingXml("11. Mapa lógico del problema", 2));
  parts.push(paragraphXml(generarMapaLogico(resultado)));

  parts.push(headingXml("12. Diseños metodológicos sugeridos", 2));
  generarDisenos(txtBase, resultado).split("\n").forEach(l => parts.push(paragraphXml(l, { bullet: true })));

  parts.push(headingXml("13. Nota para estudiantes de la Universidad de Zaragoza", 2));
  ...
  parts.push(headingXml("14. Nota APA para citar SOCIOKAIROS", 2));
  ...
  parts.push(headingXml("15. Advertencia académica", 2));
