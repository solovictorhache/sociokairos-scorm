...
function geoFuentes(ciudad, pais, area, lower) {
  ...
  if (["salud mental", "salud", "enfermedad", "ansiedad", "depresión", "depresion"].some(k => topic.includes(k))) {
  ...
  if (["trabajo", "empleo", "paro", "laboral"].some(k => topic.includes(k))) {
  ...
  if (["educación", "educacion", "abandono escolar", "deserción", "desercion"].some(k => topic.includes(k))) {
  ...
  if (["violencia de género", "violencia de genero", "maltrato"].some(k => topic.includes(k))) {
...
function detectarSubdominios(areas, vi, vd, lower) {
  ...
  if (areas.some(a => a.toLowerCase().includes("urbana")) || ["barrio", "vecindario", "segregación", "gentrificación"].some(k => lower.includes(k))) {
    subs = subs.concat(["estigma territorial", "gentrificación", "segregación espacial y escolar"]);
  }
  if (areas.some(a => a.toLowerCase().includes("género")) || ["masculinidad", "masculinidades", "feminidad", "feminidades"].some(k => lower.includes(k))) {
...
function sugerirDisenoEstudio(lower) {
  ...
  if (["etnografía", "etnografia", "observación participante", "observacion participante"].some(w => lower.includes(w))) {
  ...
  if (["experimento", "experimental", "ensayo controlado"].some(w => lower.includes(w))) {
  ...
  if (["barrios", "barrio", "territorio", "comunidad", "participativo"].some(w => lower.includes(w))) {
  ...
  if (["violencia", "maltrato", "feminicidio", "salud mental", "ansiedad", "depresión", "depresion", "menor", "menores", "niño", "niños", "niña", "niñas", "infancia", "adolescente"].some(w => lower.includes(w))) {
...
function validarProblemaEdu(texto) {
  ...
  const preguntaCotidiana = ["cuánto dinero", "cuanto dinero", "qué dinero", "que dinero", "tiene dinero", "gana dinero"].some(x => t.includes(x));
